...
UNIX BUILD NOTES FOR CNYCOIN
====================

To build in Terminal on Debian based Linux
---------------------

	git clone https://github.com/cnycoin/cnycoin
	cd cnycoin
...
This will build CnyCoin-Qt as well if the dependencies are met.
...
Note: Currently, there is no cnycoin ebuild available in overlay 
...
Notes
-----
The release is built with GCC and then "strip cnycoind" to strip the debug
