...
2.a) Build from QT Creator

    make distclean
    qmake
    "Build in QT", check peercoin-qt file.

    you will find wallet-app: peercoin-qt in QT Creator folder (ex: build-bitcoin-qt-Desktop-Debug).
...
See [readme-qt.md](readme-qt.md) for more information.
    ...
    You will find peercoin-qt at ./src/qt/peercoin-qt, peercoind at ./src/peercoind
